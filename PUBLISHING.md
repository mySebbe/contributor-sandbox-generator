...
1. Create the GitHub repository at `https://github.com/mySebbe/contributor-sandbox-generator`.
2. Create the PyPI project named `contributor-sandbox-generator`.
3. In PyPI, add a Trusted Publisher for:
   - Owner: `mySebbe`
   - Repository: `contributor-sandbox-generator`
